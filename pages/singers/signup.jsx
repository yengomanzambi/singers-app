...
export default function Signup(){
  ...
  <div className="w-full sm:max-w-md p-5 mx-auto">
    ...
    <form>
      ...
      <div className="mt-6">
        <button class="w-full inline-flex items-center justify-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-semibold capitalize text-white hover:bg-red-700 active:bg-red-700 focus:outline-none focus:border-red-700 focus:ring focus:ring-red-200 disabled:opacity-25 transition">Inscription</button>
      </div>
